    ...
    return (
        <footer className={styles.footer}>
            <div className={styles.footerWrapper}>
                <div  onClick={() => window.location.replace("/feed")} className={isFeedActive ? styles.iconActive : styles.icon}>
                    <div className={styles.iconDiv}>
                        <TabFeedIcon color={isFeedActive ? '#7462FF' : '#A1A1A1'} width={24} height={24} />
                        <p className={isFeedActive ? styles.iconText + "  " + styles.iconTextActive : styles.iconText}>Лента</p>
                    </div>
                </div>

                <div  onClick={() => window.location.replace("/mates")} className={isMatesActive ? styles.iconActive : styles.icon}>
                    <div className={styles.iconDiv}>
                        <TabMatesIcon color={isMatesActive ? '#7462FF' : '#A1A1A1'} width={24} height={24} />
                        <p className={isMatesActive ? styles.iconText + "  " + styles.iconTextActive : styles.iconText}>Мейты</p>
                    </div>
                </div>
                ...
                <div onClick={() => window.location.replace("/")} className={isProfileActive ? styles.iconActive : styles.icon}>
                    <div className={styles.iconDiv}>
                        <TabProfileIcon color={isProfileActive ? '#7462FF' : '#A1A1A1'} width={24} height={24}/>
